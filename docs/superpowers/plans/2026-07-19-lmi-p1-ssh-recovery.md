...
- [ ] **Step 1: Write failing fake-fastboot tests**
  ...
  ```text
  [fastboot.exe, -s, <device-serial>, -S, 256M, flash, userdata, /absolute/fresh/xiaomi-lmi.img]
  [fastboot.exe, -s, <device-serial>, boot, /absolute/fresh/boot-ram.img]
  [fastboot.exe, -s, <device-serial>, flash, boot, /absolute/fresh/boot-persistent.img]
  [fastboot.exe, -s, <device-serial>, reboot]
  ```
